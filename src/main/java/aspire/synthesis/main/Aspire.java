...
import aspire.compiler.ast.Query;
import aspire.compiler.parser.BuildAstVisitor;
import aspire.compiler.parser.SpyroLexer;
import aspire.compiler.parser.SpyroParser;
import aspire.synthesis.*;
import aspire.synthesis.main.cmdline.SpyroOptions;
import aspire.synthesis.primitives.*;
import aspire.util.SketchHelper;
import aspire.util.exceptions.ParseException;
